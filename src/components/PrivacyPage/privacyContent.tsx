		...
		<>
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					Websitezugriffe und sonstige Daten, die &uuml;ber eine Website generiert werden,
					handeln.
				</p>{' '}
				<p>
				...
				<p>
					...
					zur Erf&uuml;llung seiner Leistungspflichten erforderlich ist und unsere
	...
	en: (
		<>
			...
			<div className={styles.dataSection}>
				<h3>General Notes</h3>{' '}
				<p>
					The following notes provide a simple overview of what happens with your personal
					data when you visit this website. Personal data is all data with which you can
					be personally identified. Detailed information on the subject of data protection
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					can find their contact details in the section “Information on the Responsible
					Party” in this privacy policy.
				</p>{' '}
				<h4>How do we collect your data?</h4>{' '}
				<p>
					Your data is collected on the one hand by you providing it to us. This could,
					for example, be data you enter in a contact form.
				</p>{' '}
				<p>
					Other data is automatically collected or after your consent by our IT systems
					when you visit the website. This is mainly technical data (e.g., internet
					browser, operating system, or time of the page view). This data is collected
				...
				<p>
					...
					origin, recipient, and purpose of your stored personal data. You also have a
					...
					future. Moreover, you have the right under certain circumstances to request the
					restriction of the processing of your personal data. Furthermore, you have a
					right of appeal to the competent supervisory authority.
				</p>{' '}
				<p>
					For this as well as for further questions on the subject of data protection, you
					can contact us at any time.
				</p>
			</div>
			<div className={styles.dataSection}>
				<h3>Analysis Tools and Tools by Third-party Providers</h3>{' '}
				<p>
					When visiting this website, your surfing behavior can be statistically
					evaluated. This happens primarily with so-called analysis programs.
				</p>{' '}
				<p>
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					is stored on the servers of the host. This may include, but is not limited to,
					IP addresses, contact requests, meta and communication data, contract data,
					contact details, names, website access, and other data generated through a
					website.
				</p>{' '}
				<p>
					External hosting is done for the purpose of contract fulfillment towards our
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					communicating by email) can have security gaps. Complete protection of data
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					processing no longer applies. If you submit a legitimate request for deletion or
					...
					occur after these reasons no longer apply.
				</p>
			</div>
			<div className={styles.className}>
				<h3>General Notes on the Legal Bases for Data Processing on This Website</h3>{' '}
				<p>
					If you have consented to data processing, we process your personal data based on
					Art. 6 Para. 1 lit. a GDPR or Art. 9 Para. 2 lit. a GDPR if special categories
					of data according to Art. 9 Para. 1 GDPR are processed. In the case of explicit
					consent to the transfer of personal data to third countries, data processing is
					also based on Art. 49 Para. 1 lit. a GDPR. If you have consented to the storage
					of cookies or to access information on your end device (e.g., via device
					fingerprinting), processing is also based on § 25 Para. 1 TTDSG. The consent can
					be revoked at any time. If your data is required for contract fulfillment or for
					carrying out pre-contractual measures, we process your data based on Art. 6
					Para. 1 lit. b GDPR. Furthermore, if your data is required to fulfill a legal
					obligation, we process it on the basis of Art. 6 Para. 1 lit. c GDPR. Data
					processing may also be based on our legitimate interest according to Art. 6
					Para. 1 lit. f GDPR. Information on the relevant legal basis in each individual
			...
			<div className={styles.dataSection}>
				...
				<p>
					As part of our business activities, we work with various external entities. In
					some cases, it is also necessary to transfer personal data to these external
					entities. We only pass on personal data to external entities if this is
					necessary for the fulfillment of a contract, if we are legally obliged to do so
					(e.g., data transfer to tax authorities), if we have a legitimate interest
					according to Art. 6 Para. 1 lit. f GDPR in the transfer, or if another legal
					basis allows the data transfer. When using processors, we only pass on personal
					data of our customers based on a valid contract for order processing. In the
					case of joint processing, a contract for joint processing is concluded.
				</p>
			</div>
			<div className={styles.dataSection}>
				...
				<p>
					...
					can revoke any consent you have already given at any time. The legality of the
			...
			<div className={styles.dataSection}>
				...
				<p>
					IF DATA PROCESSING IS BASED ON ART. 6 PARA. 1 LIT. E OR F GDPR, YOU HAVE THE
					RIGHT AT ANY TIME TO OBJECT TO THE PROCESSING OF YOUR PERSONAL DATA FOR REASONS
					ARISING FROM YOUR PARTICULAR SITUATION; THIS ALSO APPLIES TO PROFILING BASED ON
					THESE PROVISIONS. THE RESPECTIVE LEGAL BASIS ON WHICH A PROCESSING IS BASED CAN
					BE FOUND IN THIS PRIVACY POLICY. IF YOU OBJECT, WE WILL NO LONGER PROCESS YOUR
					AFFECTED PERSONAL DATA UNLESS WE CAN DEMONSTRATE COMPELLING LEGITIMATE GROUNDS
				...
				<p>
					...
					FOR THE PURPOSE OF SUCH MARKETING; THIS ALSO APPLIES TO PROFILING TO THE EXTENT
					THAT IT IS RELATED TO SUCH DIRECT MARKETING. IF YOU OBJECT, YOUR PERSONAL DATA
			...
			<div className={styles.dataSection}>
				...
				<p>
					In the event of violations of the GDPR, data subjects have a right to file a
					complaint with a supervisory authority, especially in the Member State of their
					habitual residence, place of work or place of the alleged violation. The right
			...
			<div className={styles.dataSection}>
				...
				<p>
					You have the right to have data that we process based on your consent or in
					fulfillment of a contract automatically delivered to yourself or to a third
					party in a standard, machine-readable format. If you request the direct transfer
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					correction or deletion of this data. For this purpose, as well as for further
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					data. For this purpose, you can contact us at any time. The right to restrict
				...
				<ul>
					...
					<li>
						...
						or assert legal claims, you have the right, instead of deletion, to request
						the restriction of the processing of your personal data.
					</li>{' '}
					<li>
						If you have lodged an objection according to Art. 21 Para. 1 GDPR, a balance
						must be struck between your interests and ours. As long as it has not been
				...
				<p>
					...
					establishment, exercise, or defense of legal claims or for the protection of the
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					(so-called third-party cookies). Third-party cookies enable certain services of
					third-party companies to be integrated within websites (e.g., cookies for
					processing payment services).
				</p>{' '}
				<p>
					Cookies have various functions. Numerous cookies are technically necessary since
					certain website functions would not work without them (e.g., the shopping cart
					function or the display of videos). Other cookies can be used to analyze user
					behavior or for advertising purposes.
				</p>{' '}
				<p>
					Cookies that are necessary for the execution of the electronic communication
					process, for providing certain functions you desire (e.g., for the shopping cart
					function), or for optimizing the website (e.g., cookies for measuring the web
					audience) are stored on the basis of Art. 6 Para. 1 lit. f GDPR, unless another
					legal basis is specified. The website operator has a legitimate interest in
					storing cookies for the technically error-free and optimized provision of its
					services. If consent to the storage of cookies and comparable recognition
					technologies was requested, the processing is carried out exclusively on the
					basis of this consent (Art. 6 Para. 1 lit. a GDPR and § 25 Para. 1 TTDSG);
			...
			<div className={styles.dataSection}>
				...
				<p>
					...
					personal data (name, inquiry) will be stored and processed by us for the purpose
					of processing your request. We do not pass on this data without your consent.
				</p>{' '}
				<p>
					The processing of this data is based on Art. 6 Para. 1 lit. b GDPR if your
					request is related to the execution of a contract or is necessary for the
					...
					addressed to us (Art. 6 Para. 1 lit. f GDPR) or on your consent (Art. 6 Para. 1
					lit. a GDPR) if this was requested; consent can be revoked at any time.
				</p>{' '}
				<p>
					The data sent by you to us via contact requests remain with us until you request
					us to delete, revoke your consent to storage, or the purpose for data storage
			...
			<div className={styles.dataSection}>
				<h3>Google Fonts</h3>{' '}
				<p>
					This page uses Google Fonts for uniform font representation, provided by Google.
					When you call up a page, your browser loads the required fonts into your browser
				...
				<p>
					The company has a certification according to the “EU-US Data Privacy Framework”
					(DPF). The DPF is an agreement between the European Union and the USA to ensure
					compliance with European data protection standards in data processing in the
					USA. Each company certified under the DPF commits to comply with these data
					protection standards. You can obtain further information from the provider at
					the following link:{' '}
					<a
						href='https://www.dataprivacyframework.gov/s/participant-search/participant-detail?contact=true&id=a2zt000000001L5AAI&status=Active'
						target='_blank'
